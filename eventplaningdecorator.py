...
class DespesaDecorator:
    def __init__(self, despesa):
        self._despesa = despesa

    def get_valor_com_imposto(self):
        # Adicionar um imposto de 10% ao valor da despesa
        return self._despesa.valor * 1.1
...
class Evento:
    ...
    def adicionar_despesa_evento(self, descricao, valor):
        ...
        despesa_decorada = DespesaDecorator(despesa)  # Aplicar o decorator
        self.orcamento.adicionar_despesa(despesa_decorada)
